package com.belcorp.auto.database.manager;
...
public class JavaConnection {
    ...
    public static Connection creteConnection(String connectionURL,String userDatabase, String passwordDatabase) throws SQLException {
        try {
